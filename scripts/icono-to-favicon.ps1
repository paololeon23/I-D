...
$icono = Join-Path $root 'icono.png'
if (-not (Test-Path $icono)) { throw "No existe icono.png en $root" }

$src = [System.Drawing.Image]::FromFile($icono)
...
$ico32.Dispose()
$src.Dispose()
Write-Output 'Iconos generados desde icono.png'
